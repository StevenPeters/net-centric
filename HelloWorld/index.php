...
<html>
    ...
    <body>
        <div id="main">
            <h1 id="top">
                Hello World: Information on Our Home
            </h1>
            <p id="paragraph 1">
                <text>Earth, otherwise known as the world, is the third planet from the Sun and the only object in the Universe known to harbor life. It is the densest planet in the Solar System and the largest of the four terrestrial planets.
            </p>
            <p id="paragraph 2">
        ...
        <div id="nav">
            ...
            <p>
                <a href="#paragraph 1">Paragraph 1</a>
            </p>
            <p>
                <a href="#paragraph 2">Paragraph 2</a>
            </p>
            <p>
                <a href="#paragraph 3">Paragraph 3</a>
            </p>
            <p>
                <a href="#paragraph 4">Paragraph 4</a>
            </p>
        </div>
    </body>
</html>
